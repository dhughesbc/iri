...
public class StorageTransactions extends AbstractStorage {
    ...
    public TransactionViewModel loadTransaction(final long pointer) {
        synchronized (Storage.class) {
            ...
            return Storage.loadTransactionViewModel(mainBuffer);
    	}
    }
    ...
    public long storeTransaction(final byte[] hash, final TransactionViewModel transactionViewModel, final boolean tip) { // Returns the pointer or 0 if the transactionViewModel was already in the replicator and "transactionViewModel" value is not null
